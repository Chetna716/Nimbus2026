...
const RcRaceSection = () => {
    ...
    return (
        <section ref={containerRef} className="w-full min-h-screen bg-[#020202] text-white relative flex items-center justify-center py-16 md:py-24 z-10 overflow-hidden">
