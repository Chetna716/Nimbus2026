...
const DroneSection = () => {
    ...
    return (
        <section ref={containerRef} className="w-full min-h-screen bg-[#020205] text-white relative flex items-center justify-center py-16 md:py-24 z-10 overflow-hidden border-t border-b border-cyan-900/30">
            {/* Cyberpunk/Sky Atmosphere */}
            <div className="absolute inset-0 pointer-events-none z-0">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(0,255,255,0.08)_0%,transparent_60%),radial-gradient(circle_at_20%_80%,rgba(0,100,255,0.05)_0%,transparent_50%)]" />
            ...
            >
                <h1 className="text-[6rem] sm:text-[8rem] md:text-[12rem] lg:text-[18rem] xl:text-[24rem] font-bankgothic font-black text-transparent whitespace-nowrap opacity-10"
                    style={{ WebkitTextStroke: '2px rgba(0, 255, 255, 0.3)' }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 flex flex-col justify-center relative z-20 order-2 lg:order-1">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <span className="text-cyan-400 font-mono tracking-[0.3em] text-sm md:text-base uppercase font-bold">Aerial Combat</span>
                            </div>

                            <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black uppercase font-bankgothic text-white leading-none mb-4 drop-shadow-[0_0_30px_rgba(0,255,255,0.2)]">
                                DRONE<br />RACING
                            </h2>
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bankgothic text-white/50 mb-8 uppercase tracking-widest">
                                Sky <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Supremacy</span>
                            </h3>

                            <div className="w-full h-[1px] bg-gradient-to-r from-cyan-900/50 to-transparent mb-8"></div>
                    ...
                    <div className="lg:col-span-6 relative group order-1 lg:order-2">
                        ...
                        >
                            ...
                            <div className="absolute -top-4 -right-4 w-24 h-24 border-t-2 border-r-2 border-cyan-400/50 z-20 group-hover:scale-110 group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform duration-500"></div>
                            <div className="absolute -bottom-4 -left-4 w-24 h-24 border-b-2 border-l-2 border-blue-500/50 z-20 group-hover:scale-110 group-hover:translate-y-1 group-hover:-translate-x-1 transition-transform duration-500"></div>

                            {/* Main Image Container */}
                            <div className="relative w-full h-full overflow-hidden bg-black border border-white/5 shadow-[0_0_50px_rgba(0,255,255,0.15)] filter grayscale-[30%] group-hover:grayscale-0 transition-all duration-700 transform-gpu translate-z-0">
                                <Image
                                ...
                                />
                                {/* Overlay Gradient */}
                                <div className="absolute inset-0 bg-gradient-to-tr from-black/80 via-transparent to-cyan-900/20" />
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-4 left-4 md:bottom-10 md:-left-12 z-30 bg-black/80 backdrop-blur-md border border-cyan-500/30 p-3 md:p-4 shadow-[0_0_30px_rgba(0,255,255,0.2)] skew-x-[10deg]"
                            >
                                <div className="skew-x-[-10deg]">
                                    <p className="text-cyan-400 font-mono text-[9px] md:text-[10px] tracking-widest uppercase mb-1">Prize Pool</p>
                                    <p className="text-xl md:text-3xl font-bankgothic text-white drop-shadow-[0_0_10px_rgba(0,255,255,0.8)]">₹80,000</p>
                                </div>
                            </motion.div>
